...
class StepUpOTPPayload(BaseModel):
    purpose: str = Field("payout_stepup", description="Purpose for step-up OTP challenge (e.g. payout_stepup, phone_update, wallet_withdrawal)")
    amount: Optional[int] = Field(None, description="Optional withdrawal amount in whole KES for pre-validation")
